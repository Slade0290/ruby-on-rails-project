class CarsDetailsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @cars_detail.save
        format.html { redirect_to car_cars_details_url, notice: 'Cars detail was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      ...
      if @cars_detail.update(cars_detail_params)
        ...
        format.html { redirect_to car_cars_details_url, notice: 'Cars detail was successfully updated.' }
  ...
  def destroy
    @cars_detail.destroy
    respond_to do |format|
      format.html { redirect_to cars_details_url, notice: 'Cars detail was successfully destroyed.' }
